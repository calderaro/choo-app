...
/***/ function(module, exports, __webpack_require__) {
	...
	app.model({
	  ...
	  effects: {
	    ...
	    changeTodo: function changeTodo(_ref2, state, send, done) {
	      var data = _ref2.data;
	      var index = _ref2.index;

	      var todo = _extends({}, state.todos[index], data);
	      store.replace('todos', index, todo, function (item) {
	        send('replaceTodo', { index: index, todo: todo }, done);
	      });
	    }
	  }
	});
